...
import { Mail, Lock, Eye, EyeOff, Code, Chrome } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900/50 text-purple-200 rounded-full">or continue with email</span>
            </div>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <Button
                ...
                className="w-full"
              >
                {loading ? 'Logging in...' : 'Login to PyKIDS! 🚀'}
              </Button>
            </motion.div>
          </form>
          ...
          >
            <p className="text-purple-200">
              ...
              <Link to="/signup" className="text-purple-300 hover:text-purple-100 font-medium transition-colors">
                Sign up here!
              </Link>
            </p>
          </motion.div>
